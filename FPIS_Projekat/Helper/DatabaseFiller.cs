...
namespace FPIS_Projekat.Helper
{
    public class DatabaseFiller
    {
        ...
        private static void PopulateTerminiTerapija(FPISDBContext context)
        {
                ...
                context.TerminiTerapije.AddRange(new List<TerminTerapije>
            {
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,2,9,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,2,10,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,2,11,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,2,12,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,2,13,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,2,14,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,2,15,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,2,16,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                ...
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,3,9,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,3,10,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,3,11,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,3,12,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,3,13,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,3,14,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,3,15,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
                new TerminTerapije()
                {
                    VremeDatumTerapije = new DateTime(2019,5,3,16,0,0),
                    RadnikId =  1,
                    Kapacitet = 6,
                    SifraUsluge = 1
                },
        ...
        private static void PopulateUputZaTerapiju(FPISDBContext context)
        {
                ...
                context.UputiZaTerapiju.AddRange(new List<UputZaTerapiju>
            {
                ...
                {
                    BrojUputa = "11111111",
                    DatumIzdavanja = new DateTime(2018,11,25),
                    JmbgPacijenta = "0404987468412",
                    RedniBrojZahteva = 1,
                    RokVazenja = new DateTime(2019,5,25),
                    SifraTerapije = 1,
                    SifraUstanove = 1
                },
                new UputZaTerapiju()
