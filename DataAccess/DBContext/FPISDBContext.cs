...
{
    public class FPISDBContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            #region Registracija Refresh Tokena
            ...
            modelBuilder.Entity<RefreshToken>()
                .Property(t => t.ExpiryTime).IsRequired();
            #endregion

            #region Registracija tabela
